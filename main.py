...
elevators_data = [
    ...
    Elevator(position=5, capacity=5)
]
...
people_data = [
    ...
    Person(start_pos=1, destination=8),
    Person(start_pos=3, destination=0),
    Person(start_pos=2, destination=4),
    Person(start_pos=4, destination=6),
    Person(start_pos=5, destination=0),
    Person(start_pos=8, destination=2),
    Person(start_pos=7, destination=9),
    Person(start_pos=0, destination=3)
]
